...
<body>
<div id="admin_header">
  <div id="admin_logo"><img style="height: 50px;" src="__ASSETS__/images/logo1.png" /></div>
  <div id="submenu-div">
    <ul>
...
<div id="admin_menubar">
  ...
  <dl>
    <dt class="menu_title">公告管理</dt>
    <dd>
      <ul>
        <li><a href="{url('articlecat/index')}" target="mainFrame">公告分类</a></li>
        <li><a href="{url('article/index')}" target="mainFrame">公告列表</a></li>
      </ul>
    </dd>
  </dl>
  <dl>
...
<div id="admin_bottom" style="text-align:center; line-height:30px">Copyright &copy; <?php echo date('Y');?> {$lang['copyright']}</div>
