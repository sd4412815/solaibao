...
body {
	...
	background-image: url(__ASSETS__/images/login_bg02.jpg);
...
<form method="post" action="{url('forget')}" name='theForm'>
  <table cellspacing="0" cellpadding="0" align="center" class="loginbg">
    <tr>
      <td height="100" align="center" valign="middle"><a href="javascript:void(0)" target="_blank"><img src="__ASSETS__/images/logo.png" class="loginlogo" /></a></td>
    </tr>
    <tr>
