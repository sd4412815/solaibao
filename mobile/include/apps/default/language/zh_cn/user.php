...
$_LANG['validate_edit_password'] = '验证成功,请修改密码';
$_LANG['reedit_password'] = '两次输入密码不一致';
$_LANG['label_order'] = '我的订单';
$_LANG['label_address'] = '收货地址';
$_LANG['label_message'] = '我的留言';
$_LANG['label_tag'] = '我的标签';
$_LANG['label_collection'] = '我的收藏';
$_LANG['label_earnings'] = '我的收益';
$_LANG['label_gross'] = '收益总额';
$_LANG['label_revenue'] = '收益总收入';
$_LANG['label_integral'] = '收益积分';
$_LANG['label_income'] = '可用收益';
$_LANG['label_accumulated'] = '您的累积收益';
$_LANG['label_bonus'] = '我的红包';
$_LANG['label_comment'] = '我的评论';
$_LANG['label_share'] = '我的分享';
$_LANG['label_group_buy'] = '我的团购';
$_LANG['label_invite'] = '我的邀请';
...
$_LANG['current_surplus'] = '您当前的可用余额为：';
$_LANG['unit_yuan'] = '元';
$_LANG['for_free'] = '赠品免费';
...
$_LANG['oldpassword_success'] = '您的密码已修改成功！';
...
$_LANG['username_no_mobile'] = '您填写的手机号码与登记手机号不匹配，请重新输入！';
$_LANG['fail_send_password'] = '发送邮件出错，请与管理员联系！';
$_LANG['send_success'] = '重置密码的邮件已经发到您的邮箱：';
$_LANG['send_success_mobile'] = '重置密码的信息已发送到您的手机：';
...
$_LANG['passport_js']['password_length'] = '- 登录密码不能超过 18 个字符。';
