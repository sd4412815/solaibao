...
class IndexController extends CommonController {
    ...
    public function index() {
        ...
        $this->assign('best_goods', model('Index')->goods_list('best',4,0));//分别为 显示哪行，显示几个，从第几个显示
        $this->assign('new_goods', model('Index')->goods_list('new', 4,0));//分别为 显示哪行，显示几个，从第几个显示
        $this->assign('hot_goods', model('Index')->goods_list('hot', 4,0));//分别为 显示哪行，显示几个，从第几个显示
        //首页推荐分类
