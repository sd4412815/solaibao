...
class CategoryController extends CommonController {
    ...
    public function index() {
        ...
        $goods_list = $this->category_get_goods();
    ...
    $sql   = "SELECT COUNT(*) AS count FROM " .$this->model->pre. "goods AS g ".
        "WHERE g.is_delete = 0 AND g.is_on_sale = 1 AND g.goods_number > 0 AND g.is_alone_sale = 1 $attr_in AND supplier_id = 0 AND (( 1 " . $this->categories . $this->keywords . $this->intro . $this->outstock ." )))";
