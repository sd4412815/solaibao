...
class IndexModel extends CommonModel {
     ...
     * @param  $start
     */
    public function goods_list($type = 'best', $limit = 0, $start = 0) {
        if ($type == 'new') {
            $type = 'g.is_new = 1';
        } else if ($type == 'hot') {
            $type = 'g.is_hot = 1';
        ...
        $sql .= ' WHERE g.supplier_id=0 AND g.is_on_sale = 1 AND g.is_alone_sale = 1 AND g.goods_number != 0 AND g.is_delete = 0 AND ' . $type;
        ...
        foreach ($result as $key => $vo) {
            ...
            // print_r(get_image_path($vo['goods_id'], $vo['goods_thumb'], true));die;
    ...
    function get_promote_goods($cats = '') {
        ...
        $sql = 'SELECT g.goods_id, g.goods_name, g.goods_name_style, g.market_price, g.shop_price AS org_price, g.promote_price, ' .
                ...
                'WHERE g.supplier_id=0 AND g.is_on_sale = 1 AND g.is_alone_sale = 1 AND g.goods_number != 0 AND g.is_delete = 0 ' .
        ...
        foreach ($result AS $idx => $row) {
            ...
            $goods[$idx]['short_name'] = goods_listC('goods_name_length')>0 ? sub_str($row['goods_name'],C('goods_name_length')):$row['goods_name'];
