...
//            $email,
    ...
    function edit_user($cfg)
    {
        ...
        $values = array();
        $values[] = $this->field_name . "='" . $cfg['username'] . "'";
        ...
        if ($values) {
           // $sql = "UPDATE " . $this->db->pre . $this->user_table . " SET " . implode(', ', $values) . " WHERE " . $this->field_name . "='" . $cfg['post_username'] . "' LIMIT 1";
            $sql = "UPDATE " . $this->db->pre . $this->user_table . " SET " . implode(', ', $values) . " WHERE " . $this->field_id . "='" . $cfg['user_id'] . "' LIMIT 1";
