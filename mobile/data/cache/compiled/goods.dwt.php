...
?> 
  ...
  <div class="goods-info ect-padding-tb"> 
    ...
    <section class="ect-margin-tb ect-margin-lr ">
      <p>
      <span class="pull-left" ><?php echo $this->_var['lang']['amount']; ?>：<b style="color:rgb(253,84,102)"  id="ECS_GOODS_AMOUNT" ></b></span>
      <span class="pull-right" ><?php echo $this->_var['lang']['sort_sales']; ?>：<?php if ($this->_var['sales_count']['sales_count'] == ''): ?> 0 <?php else: ?><?php echo $this->_var['sales_count']['sales_count']; ?> <?php endif; ?> <?php echo $this->_var['lang']['piece']; ?></span>
      </p>
      <p ><?php if ($this->_var['goods']['is_promote'] && $this->_var['goods']['gmt_end_time']): ?><?php echo $this->_var['lang']['promote_price']; ?><?php else: ?><?php echo $this->_var['lang']['shop_price']; ?><?php endif; ?><?php if ($this->_var['goods']['is_promote'] && $this->_var['goods']['gmt_end_time']): ?> 
        ...
        <?php endif; ?>
         <small>
          <del><?php if ($this->_var['cfg']['SHOW_MARKETPRICE']): ?><?php echo $this->_var['goods']['market_price']; ?> 
          <?php endif; ?>
          </del>
          </small>
	  </p>
    ...
    <p>
      <span class="pull-left">进口税率：<?php echo $this->_var['goods_tax']; ?>%</span>
    </p>
...
?>
          ...
          <div class="tab-pane tab-msg" id="three">
            <ul class="msg">
              <?php echo $this->fetch('library/comments_list.lbi'); ?>
...
?></div>
  ...
  <div class="goods-related ect-padding-lr ect-padding-tb">
    ...
    <div id="picScroll" class="picScroll">
      ...
      <div class="bd">
        <ul>
          <?php $_from = $this->_var['related_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_11091900_1464921066');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_11091900_1464921066']):
        $this->_foreach['goods']['iteration']++;
?>
          <li><a href="<?php echo $this->_var['goods_0_11091900_1464921066']['url']; ?>"><img _src="<?php echo $this->_var['goods_0_11091900_1464921066']['goods_thumb']; ?>" src="<?php echo $this->_var['goods_0_11091900_1464921066']['goods_thumb']; ?>" /></a>
            <p class="ect-color"> 
              <?php if ($this->_var['goods_0_11091900_1464921066']['promote_price']): ?> 
              <?php echo $this->_var['goods_0_11091900_1464921066']['formated_promote_price']; ?>
              <?php else: ?> 
              <?php echo $this->_var['goods_0_11091900_1464921066']['shop_price']; ?>
              <?php endif; ?> 
            </p>
            <p class="text-left"><?php echo $this->_var['goods_0_11091900_1464921066']['short_name']; ?></p>
          </li>
