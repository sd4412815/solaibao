...
<style>
	...
	.information_center > a > li{
		border-bottom:none;}
	.by_go{
		background-image:url(themes/default/images/gwc.png);
...
<div class="user-info">
  <div class="user-img pull-left">
    <?php if ($this->_var['user_info']['avatar']): ?>
    <img style="width: 80px;height: 80px;" src="<?php echo $this->_var['base_path']; ?>/<?php echo $this->_var['user_info']['avatar']; ?>" alt="">
    <?php else: ?>
  ...
  <dl class="pull-left">
    <dt>
      <h4><a class="ect-colorf" href="<?php echo url('user/profile');?>"><?php echo $this->_var['info']['username']; ?> </a>| <a href="<?php echo url('user/logout');?>" class="ect-colorf"><?php echo $this->_var['lang']['label_logout']; ?></a></h4>
    </dt>
...
<section class="container-fluid user-nav">
  <ul class="row ect-row-nav text-center" style="background-color:#f7f7f7">
     ...
     <li class="mydingdan">我的订单</li>
        ...
        <a href="<?php echo url('comment/comment_list');?>">
        <li class="col-sm-3 col-xs-3"><i class="glyphicon glyphicon-comment"></i>
          <p class="text-center"><?php echo $this->_var['lang']['label_comment']; ?></p>
        </li>
        </a>
    ...
    <div class="information_center">
      <li class="interval">信息中心</li>
        ...
        <a href="<?php echo url('user/send_pwd_edit');?>">
    ...
    <li class="col-sm-3 col-xs-3"><i class="glyphicon glyphicon-link"></i>
      <p class="text-center">10<?php echo $this->_var['lang']['label_booking']; ?></p>
    </li>
    </a> -->
...
<section class="user-tab ect-margin-tb ect-margin-bottom0"> 
  ...
  <ul class="nav nav-tabs text-center">
    <li class="col-xs-4 active cl"><a href="#one" role="tab" data-toggle="tab"><?php echo $this->_var['lang']['label_collection']; ?></a></li>
          ...
          <dl>
            ...
            <dd class="dd-price">
              <span class="pull-left">
                <strong><?php echo $this->_var['lang']['sort_price']; ?>：
                  <b class="ect-colory"><?php echo $this->_var['val']['shop_price']; ?></b>
                </strong>
                <small class="ect-margin-lr">
                  <del><?php echo $this->_var['val']['market_price']; ?>
                  </del>
                </small>
                  <dd class="text-center">

                 <!-- <a class="flow-del jr" href="javascript:addToCart(<?php echo $this->_var['val']['goods_id']; ?>)"><?php echo $this->_var['lang']['add_to_cart']; ?> </a> --> 
            ...
            <a class="pull-right del" href="<?php echo url('user/delete_collection', array('rec_id'=>$this->_var['val']['rec_id']));?>" style="margin-right:10px;" ><img class="ljx" src="themes/default/images/lajixiang.png"><!--<i class="glyphicon glyphicon-trash"></i> --></a>
            <div class="pull-right jr by_go"><a  href="javascript:addToCart(<?php echo $this->_var['val']['goods_id']; ?>)"><?php echo $this->_var['lang']['add_to_cart']; ?> </a></div>
          </li>
...
?>
        <li>
          <dl>
            ...
            <?php endif; ?>
            <dd><a href="<?php echo url('user/delete_comment',array('id'=>$this->_var[val][comment_id]));?>" class="pull-right del"><img class="ljx" src="themes/default/images/lajixiang.png"><!--<i class="glyphicon glyphicon-trash"></i> --></a></dd>
          </dl>
        </li>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    ...
    <div class="tab-pane ect-pro-list" id="three"> 
      ...
      <a href="<?php echo url('user/clear_history');?>" class="history_clear del" style="font-size:18px; color:#666;"><img class="ljx" src="themes/default/images/lajixiang.png"><!--<i class="glyphicon glyphicon-trash"></i> --> [<?php echo $this->_var['lang']['clear_history']; ?>]</a></span>
      <ul>
