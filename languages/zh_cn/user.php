...
$_LANG['user_bonus_info'] = '共计: %d 个<br/>价值: %s';
...
$_LANG['username_no_phone'] = '您填写的手机号码与绑定手机不匹配，请重新输入！';
$_LANG['username_no_captcha'] = '您填写的验证码错误！';//添加代码 by zhuyu
$_LANG['fail_send_password'] = '发送邮件出错，请与管理员联系！';
$_LANG['mobile_send_password'] = '短信发送出错，请与手机开发商联系！';
$_LANG['send_success'] = '重置密码的邮件已经发到您的邮箱：';
$_LANG['send_success_mobile'] = '重置密码的信息已经发到您的手机：';
...
$_LANG['back_home_personal'] = '返回个人中心';
