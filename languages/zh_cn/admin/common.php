<?php
$_LANG['app_name'] = '搜来宝';
$_LANG['cp_home'] = '搜来宝后台管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2016 沈阳喜车商务服务有限公司，并保留所有权利。';
...
$_LANG['17_weixin_manage'] = '微信模块';/*增加代码 by yuanzb*/
...
$_LANG['08_comment_manage'] = '用户评论';
$_LANG['04_goods_distribution'] = '可分销商品';/*增加代码 by yuanzb 2016-3-31 11:53:11*/
...
$_LANG['article_auto'] = '公告自动发布';
$_LANG['navigator'] = '自定义导航栏';
$_LANG['07_goods_storeroom'] = '仓库管理';
...
/* 文章管理 */
$_LANG['02_articlecat_list'] = '公告分类';
$_LANG['articlecat_add'] = '添加公告分类';
$_LANG['03_article_list'] = '公告列表';
$_LANG['article_add'] = '添加新公告';
$_LANG['shop_article'] = '网店公告';
...
$_LANG['01_goods_add'] = '添加新商品';
$_LANG['04_category_list'] = '商品分类';
$_LANG['05_shaidan_manage'] = '用户晒单';
$_LANG['12_order_excel'] = '订单导出';
/* 代码增加_end  By  yuanzb */

$_LANG['10_kuaidi_order'] = '快递单列表';   //代码增加   By yuanzb
$_LANG['10_kuaidi_order2'] = '快递单历史';   //代码增加   By yuanzb
$_LANG['10_back_order'] = '退换货列表';   //代码增加  By yuanzb
$_LANG['keyword'] = '客户搜索记录';  //代码增加  By yuanzb
$_LANG['04_users_export'] = '会员导出';  //代码增加   By   yuanzb
$_LANG['11_postman_list'] = '快递员列表';          //代码增加   By   yuanzb
...
/* 代码增加_start By yuanzb */
$_LANG['02_supplier'] = '店铺管理';
$_LANG['05_supplier_rank'] = '店铺等级';
$_LANG['01_supplier_reg'] = '店铺申请';
$_LANG['02_supplier_list'] = '店铺列表';
...
$_LANG['supplier'] = '店铺管理';
$_LANG['supplier_manage'] = '店铺编辑与审核';
$_LANG['supplier_rank'] = '店铺等级';
...
$_LANG['02_goods_list_pass1'] = '商品列表';
