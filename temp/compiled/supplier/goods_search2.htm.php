...
<div class="form-div">
  <form action="javascript:searchGoods()" name="searchForm">
    ...
    <!-- 分类 -->
    <select name="cat_id">
        <option value="0"><?php echo $this->_var['lang']['goods_cat']; ?></option>
        <?php echo $this->_var['cat_list']; ?>
    </select>
    <!-- 品牌 -->
    <select name="brand_id">
        <option value="0"><?php echo $this->_var['lang']['goods_brand']; ?></option>
    ...
    <!-- 关键字 -->
    <?php echo $this->_var['lang']['keyword']; ?>
