...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td>
    <?php if ($this->_var['order']['pay_status'] == 0): ?>未付款<?php elseif ($this->_var['order']['pay_status'] == 1): ?>付款中<?php elseif ($this->_var['order']['pay_status'] == 2): ?>已付款<?php endif; ?>
  ...
  <tr>
    <td><div align="right"><strong>身份证号：</strong></div></td>
    <td><?php echo $this->_var['order']['id_card']; ?></td>
    <td></td>
    <td></td>
  </tr>
  <!-- <tr>
...
<table width="100%" cellpadding="3" cellspacing="1" style="text-align: center;">
  ...
  <tr>
    <th><div align="center"><strong><?php echo $this->_var['lang']['goods_name_brand']; ?></strong></div></th>
    <th><div align="center"><strong><?php echo $this->_var['lang']['goods_sn']; ?></strong></div></th>
    <th><div align="center"><strong><?php echo $this->_var['lang']['goods_price']; ?></strong></div></th>
    <th><div align="center"><strong><?php echo $this->_var['lang']['goods_number']; ?></strong></div></th>
    <th><div align="center"><strong><?php echo $this->_var['lang']['tax_rate']; ?>税率</strong></div></th>
    <th><div align="center"><strong><?php echo $this->_var['lang']['tax amount']; ?>税额</strong></div></th>
    <th><div align="center"><strong><?php echo $this->_var['lang']['subtotal']; ?></strong></div></th>
...
?>
    ...
    <td><div align="right" style="text-align: center;"><?php echo $this->_var['goods']['formated_goods_price']; ?></div></td>
    <td><div align="right" style="text-align: center;"><?php echo $this->_var['goods']['goods_number']; ?></div></td>
    <td><?php echo $this->_var['goods']['goods_tax']; ?>%</td>
    <td><div align="right" style="text-align: center;"><?php echo $this->_var['goods']['tax_fee']; ?></div></td>
    <td><div align="right" style="text-align: center;"><?php echo $this->_var['goods']['all_prices']; ?></div></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><?php if ($this->_var['order']['total_weight']): ?><div align="right" style="text-align: center;"><strong><?php echo $this->_var['lang']['label_total_weight']; ?>
    </strong></div><?php endif; ?></td>
    <td><?php if ($this->_var['order']['total_weight']): ?><div align="right" style="text-align: center;"><?php echo $this->_var['order']['total_weight']; ?>
    </div><?php endif; ?></td>
    <td><div align="right" style="text-align: center;"><strong><?php echo $this->_var['lang']['label_total']; ?></strong></div></td>
    <td><div align="right" style="text-align: center;"><?php echo $this->_var['goods']['all_prices']; ?></div></td>
  </tr>
</table>
</div>
...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    <td>
      <div align="right" style="font-size: 22px; color:#e95466">
        <?php echo $this->_var['lang']['label_goods_amount']; ?><strong><?php echo $this->_var['goods']['all_prices']; ?></strong>
        <?php if ($this->_var['goods']['dis_count'] > 0): ?>
          - <?php echo $this->_var['lang']['label_discount']; ?><strong><?php echo $this->_var['goods']['dis_count']; ?></strong>
        <?php endif; ?>
        <?php if ($this->_var['order']['formated_tax'] > 0): ?>
          + <?php echo $this->_var['lang']['label_tax']; ?><strong><?php echo $this->_var['order']['formated_tax']; ?></strong>
        <?php endif; ?>
        <?php if ($this->_var['order']['formated_shipping_fee'] > 0): ?>
          + <?php echo $this->_var['lang']['label_shipping_fee']; ?><strong><?php echo $this->_var['order']['formated_shipping_fee']; ?></strong>
         <?php endif; ?>
        <?php if ($this->_var['order']['formated_insure_fee'] > 0): ?>
          + <?php echo $this->_var['lang']['label_insure_fee']; ?><strong><?php echo $this->_var['order']['formated_insure_fee']; ?></strong>
        <?php endif; ?>
        <?php if ($this->_var['order']['formated_pay_fee'] > 0): ?>
          + <?php echo $this->_var['lang']['label_pay_fee']; ?><strong><?php echo $this->_var['order']['formated_pay_fee']; ?></strong>
        <?php endif; ?>
        <?php if ($this->_var['order']['formated_pack_fee'] > 0): ?>
          + <?php echo $this->_var['lang']['label_pack_fee']; ?><strong><?php echo $this->_var['order']['formated_pack_fee']; ?></strong>
        <?php endif; ?>
        <?php if ($this->_var['order']['formated_card_fee'] > 0): ?>
  ...
  <tr>
    <td><div align="right" style="font-size: 22px; color:#e95466"> = <?php echo $this->_var['lang']['label_order_amount']; ?><strong><?php echo $this->_var['goods']['endprices']; ?> </strong></div></td>
  </tr>
  <tr>
    <td><div align="right">
      <!-- - <?php echo $this->_var['lang']['label_money_paid']; ?>
      <strong><?php echo $this->_var['goods']['endprices']; ?></strong> -->
       <!-- - <?php echo $this->_var['lang']['label_surplus']; ?> <strong><?php echo $this->_var['order']['formated_surplus']; ?></strong>
      - <?php echo $this->_var['lang']['label_integral']; ?> <strong><?php echo $this->_var['order']['formated_integral_money']; ?></strong>
      - <?php echo $this->_var['lang']['label_bonus']; ?> 
      <strong><?php echo $this->_var['order']['formated_bonus']; ?></strong> -->
    </div></td>
  </tr>
  <tr>
    <td><div align="right" style="font-size: 22px; color:#e95466"> <?php if ($this->_var['order']['order_amount'] >= 0): ?><?php echo $this->_var['lang']['label_money_dues']; ?><strong><?php echo $this->_var['goods']['endprices']; ?></strong>
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <input name="invoice_no" type="text" style="color:#999; margin-left:10px;" value="请输入快递单号" /><input name="to_shipping" type="submit" style="color:#fff" value="一键发货" class="button" />
    </td>
