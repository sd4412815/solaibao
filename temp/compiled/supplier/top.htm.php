...
#submenu-div li {
float: right;
 width:77px;  text-align:center; height:58px; background:#e95466;
}
#submenu-div li a{
...
background:url(images/tp_header_hover.png) no-repeat; 
}
...
#menu-div li.midd_21 {
	background:url(images/midd.png) no-repeat;background-position:10px 12px; text-indent:12px;
...
#tabbar-div {
  background:#e95466; font-family:"微软雅黑";
width:207px; height:40px; float:left; line-height:40px; color:#ffffff; font-size:14px; font-weight:bold; text-indent:18px;
}
...
<div id="logo-div"><img src="images/logo.png" alt="店长后台管理" /></div>
