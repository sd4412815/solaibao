...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('is_on_sale'); "><?php echo $this->_var['lang']['is_best']; ?></a><?php echo $this->_var['sort_is_best']; ?></th>
      <th><a href="javascript:listTable.sort('is_best'); "><?php echo $this->_var['lang']['is_new']; ?></a><?php echo $this->_var['sort_is_new']; ?></th>
      <th><a href="javascript:listTable.sort('is_new'); "><?php echo $this->_var['lang']['is_hot']; ?></a><?php echo $this->_var['sort_is_hot']; ?></th>
      <th><a href="javascript:listTable.sort('is_hot'); "><?php echo $this->_var['lang']['is_on_sale']; ?></a><?php echo $this->_var['sort_is_on_sale']; ?></th>
    ...
    <?php endif; ?>
    <!--<th>标签</th> &lt;!&ndash; 晒单插件 增加 by yuanzb &ndash;&gt;-->
...
?>
  <tr>
    ...
    <?php endif; ?>
    <!--<td align="center"><a href="goods_tag.php?act=list&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank">标签</a></td> &lt;!&ndash; 晒单插件 增加 by yuanzb &ndash;&gt;-->
    <td align="center" style="width:90px;">
      <a href="../supplier.php?go=goods&suppId=<?php echo $this->_var['goods']['supplier_id']; ?>&id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img src="images/icon_view.gif" width="16" height="16" border="0" /></a>
