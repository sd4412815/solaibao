...
<?php endif; ?>
<span class="action-span1"><a href="index.php?act=main">欢迎您，<?php echo $this->_var['user_name']; ?>（店长管理中心）</a> </span><span id="search_id" class="action-span1"><?php if ($this->_var['ur_here']): ?> - <?php echo $this->_var['ur_here']; ?> <?php endif; ?></span>
