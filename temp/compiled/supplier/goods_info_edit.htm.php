<!-- $Id: goods_info.htm 17126 2010-04-23 10:30:26Z  $ -->
<!-- 修改 by yuanzb 百度编辑器 begin -->
            ...
            <table width="90%" id="general-table" align="center">
               ...
               <!-- <tr>
                    <td class="label">
                        ...
                        </a> <?php echo $this->_var['lang']['lab_goods_sn']; ?>
                    </td>
                    <td>
                ...
                <script>
                    function catsel(obj, level)
                    {
                        ...
                        get_tax(parentid);
                        Ajax.call('goods.php?act=get_catsel&sjs='+Math.random(), "parentid=" + parentid + "&level=" + level, catsel_response, "GET", "JSON");

                    }

                    function get_tax(parentid)
                    {
                        Ajax.call( 'goods.php?act=get_tax', 'id=' + parentid, tax_callback , 'GET', 'TEXT', true, true );
                    }

                    function tax_callback(result){
                        if(result)
                        {
                            document.getElementById('category_tax').value = result;
                        }
                        else
                        {
                            document.getElementById('category_tax').value = 0;
                        }
                    }

                    function catsel_response(res)
                    {
                        if (res.count)
                        {
                ...
                <tr>
                    ...
                    <td >
                        ...
                        <div id="catsel1" >
                            ...
                            <select name="cat_id_1" style="float:left;display:inline;margin-left:3px;" size=8 onchange="catsel(this, 1)">
...
?>
                        ...
                        <div id="catsel<?php echo $this->_var['ckey']; ?>" >
                            ...
                            <?php endif; ?>
                            <select name="cat_id_<?php echo $this->_var['ckey']; ?>" style="float:left;display:inline;margin-left:3px;" size=8 onchange="catsel(this, <?php echo $this->_var['ckey']; ?>)">
                                <option value="0" style="background:#dce6f0;">请选择&nbsp;&nbsp;&nbsp;&nbsp;</option>
...
?>
                ...
                <!-- 添加代码 by yuanzb -->
                <tr>
                    <td class="label"><?php echo $this->_var['lang']['cat_tax']; ?>：</td>
                    <td>
                    <span >
                        <input type="text" size="6" id="category_tax" name="goods_tax" value='<?php if ($this->_var['cat_info']['cat_tax']): ?><?php echo $this->_var['cat_info']['cat_tax']; ?><?php else: ?>0<?php endif; ?>'/>
                    </span>
                    </td>
                </tr>
                <!-- 添加代码 by yuanzb -->
                ...
                <?php endif; ?>
                 ...
                 <tr>
                    ...
                    <td>
                        <select name="storeroom" id="" style="width: 200px;">
                            <?php $_from = $this->_var['roomlist']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'room');if (count($_from)):
    foreach ($_from AS $this->_var['room']):
?>
                            <option value="<?php echo $this->_var['room']['store_id']; ?>"><?php echo $this->_var['room']['store_name']; ?></option>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="product_origin" style="width: 200px;">
                            <option selected="selected" value="韩国">韩国</option>
...
?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php endif; ?>
                        <p><input type="text" size="40" value="<?php echo $this->_var['lang']['lab_picture_url']; ?>" style="color:#aaa;" onfocus="if (this.value == '<?php echo $this->_var['lang']['lab_picture_url']; ?>'){this.value='http://';this.style.color='#000';}" name="goods_img_url"/></p>
                    </td>
                </tr>
                <tr id="auto_thumb_1">
                    ...
                    <td id="auto_thumb_3">
                        ...
                        <img src="images/no.gif" />
                        <?php endif; ?>
                        <p><input type="text" size="40" value="<?php echo $this->_var['lang']['lab_thumb_url']; ?>" style="color:#aaa;" onfocus="if (this.value == '<?php echo $this->_var['lang']['lab_thumb_url']; ?>'){this.value='http://';this.style.color='#000';}" name="goods_thumb_url"/></p>
                        <?php if ($this->_var['gd'] > 0): ?>
                        <label for="auto_thumb"><input type="checkbox" id="auto_thumb" name="auto_thumb" checked="true" value="1" onclick="handleAutoThumb(this.checked)" /><?php echo $this->_var['lang']['auto_thumb']; ?></label><?php endif; ?>
                    </td>
                </tr>
			 ...
			 <table width="90%" id="gallery-table" style="display:block; margin-left:27%;" align="center">
                <!-- 鍥剧墖鍒楄〃 -->
                <tr>
                    <td>
...
?>
                ...
                <tr>
                    <td>
                        ...
                        <p><input type="text" size="40" value="<?php echo $this->_var['lang']['img_file']; ?>" style="color:#aaa; margin-left:66px;" onfocus="if (this.value == '<?php echo $this->_var['lang']['img_file']; ?>'){this.value='http://';this.style.color='#000';}" name="img_file[]"/></p>
                    </td>
                </tr>
            </table>
            <!-- 璇︾粏鎻忚堪 -->
            <table width="90%" id="detail-table" style="display:block; margin-left:10%;" align="center">
                <tr>
            ...
            <!-- 鍏朵粬淇℃伅 -->
            <table width="70%" id="mix-table" style="display:block" align="center">
            ...
            <table width="90%" id="properties-table" style="display:block" align="center">
                <tr>
            ...
            <!--代码修改_start By yuanzb  将 商品相册 这部分代码完全修改成下面这样-->
            <!-- 鍟嗗搧鐩稿唽 -->
