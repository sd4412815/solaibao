...
.dingwei{
	position:absolute; right:-300px; top:50px!important
...
?>
  <tr>
    ...
    <td align="left" valign="top"><a href="mailto:<?php echo $this->_var['order']['email']; ?>"> <?php echo htmlspecialchars($this->_var['order']['consignee']); ?></a><?php if ($this->_var['order']['tel']): ?> &nbsp;&nbsp;[TEL: <?php echo htmlspecialchars($this->_var['order']['tel']); ?>]<?php endif; ?><?php if ($this->_var['order']['id_card']): ?> &nbsp;&nbsp;身份证: <?php echo htmlspecialchars($this->_var['order']['id_card']); ?><?php endif; ?> <br /><?php echo htmlspecialchars($this->_var['order']['address']); ?></td>
