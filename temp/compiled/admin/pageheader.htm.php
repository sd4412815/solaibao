...
<span class="action-span"><a class="hide_dingdan" href="<?php echo $this->_var['action_link']['href']; ?>"><?php echo $this->_var['action_link']['text']; ?></a></span>
<?php endif; ?>
...
<script>
	$(".hide_dingdan").each(function(index, element) {
        $(this).text() == "订单查询" && $(this).remove()
    });
</script>
