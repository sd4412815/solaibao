...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td width="15%"><div align="right"><strong><?php echo $this->_var['lang']['label_order_time']; ?></strong></div>
    </td>
  ...
  <tr>
    ...
    <a href="user_msg.php?act=add&order_id=<?php echo $this->_var['order']['order_id']; ?>&user_id=<?php echo $this->_var['order']['user_id']; ?>"><?php echo $this->_var['lang']['send_message']; ?></a> ]<?php endif; ?> -->
  ...
  <tr>
    ...
    <td><?php echo htmlspecialchars($this->_var['order']['id_card']); ?></td>
    <td colspan="2"></td>
...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td scope="col"><div align="center"><strong>税率</strong></div></td>
    <td scope="col"><div align="center"><strong>税额</strong></div></td>
...
?>
    ...
    <td><div align="center"><?php echo $this->_var['goods']['formated_goods_price']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['goods']['goods_number']; ?>
    </div></td>
    <td><div align="center"><?php echo $this->_var['goods']['goods_tax']; ?>%</div></td>
    <td><div align="center"><?php echo $this->_var['goods']['tax_value']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['goods']['formated_subtotal']; ?></div></td>
  </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    <td><div align="right"><?php echo $this->_var['lang']['label_goods_amount']; ?><strong><?php echo $this->_var['order']['formated_goods_amount']; ?></strong>
      ...
      <!--<span style="font-size:24px;color:red;">+</span> <?php echo $this->_var['lang']['label_tax']; ?><strong><?php echo $this->_var['order']['formated_tax']; ?></strong> --><!--发票税额 -->
      <!--<?php endif; ?>-->
      <!--<?php if ($this->_var['order']['tax_fee'] > 0): ?>-->
      <span style="font-size:24px;color:red;">+</span> 税额：<strong><?php echo $this->_var['order']['formated_tax_fee']; ?></strong>
      <!--<?php endif; ?>-->

      <!--<?php if ($this->_var['order']['shipping_fee'] > 0): ?>-->
        <span style="font-size:24px;color:red;">+</span> <?php echo $this->_var['lang']['label_shipping_fee']; ?><strong><?php echo $this->_var['order']['formated_shipping_fee']; ?></strong>
      <!--<?php endif; ?>-->

      <!--<?php if ($this->_var['order']['insure_fee'] > 0): ?>-->
      <span style="font-size:24px;color:red;">+</span> <?php echo $this->_var['lang']['label_insure_fee']; ?><strong><?php echo $this->_var['order']['formated_insure_fee']; ?></strong>
      <!--<?php endif; ?>-->
      ...
      <span style="font-size:24px;color:red;">+</span> <?php echo $this->_var['lang']['label_pack_fee']; ?><strong><?php echo $this->_var['order']['formated_pack_fee']; ?></strong>
      <!--<?php endif; ?>-->

      <!--<?php if ($this->_var['order']['card_fee'] > 0): ?>-->
      <span style="font-size:24px;color:red;">+</span> <?php echo $this->_var['lang']['label_card_fee']; ?><strong><?php echo $this->_var['order']['formated_card_fee']; ?></strong>
      <!--<?php endif; ?>-->

      <!--<?php if ($this->_var['order']['integral_money'] > 0): ?>-->
      <span style="font-size:24px;color:red;">-</span> 积分：<strong><?php echo $this->_var['order']['formated_integral_money']; ?></strong>
      <!--<?php endif; ?>-->

      <!--<?php if ($this->_var['order']['discount'] > 0): ?>-->
      <span style="font-size:24px;color:red;">-</span> <?php echo $this->_var['lang']['label_discount']; ?><strong><?php echo $this->_var['order']['formated_discount']; ?></strong>
      <!--<?php endif; ?>-->
