...
elseif ($_REQUEST['act'] == 'add')
{
    if (empty($_REQUEST['step']))
    {
        ...
        $sysmain = get_sysnav2(); //修改代码  by yuanzb 2016-3-31 09:19:27
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    if (empty($_REQUEST['step']))
    {
        ...
        $sysmain = get_sysnav2();  //修改代码  by yuanzb 2016-3-31 09:19:08
...
/*增加代码 by yuanzb 2016-3-31 09:05:41*/
/*------------------------------------------------------ */
//-- 获得系统列表
/*------------------------------------------------------ */
function get_sysnav2()
{
    global $_LANG;
    ...
    foreach($catlist as $key => $val)
    {
        ...
        $val['url'] = str_replace( '&amp;', '&', $val['url']);
        $val['url'] = 'supplier.php?go=category&suppId=' . $_SESSION['supplier_id'] . '&id='.$val['cat_id'];
        $val['url'] = str_replace( '&', '&amp;', $val['url']);
        $sysmain[] = array($val['cat_name'], $val['url'], $val['view_name']);
    }
    return $sysmain;
...
/*增加代码 by yuanzb 2016-3-31 09:05:29*/
/*------------------------------------------------------ */
//-- 列表项修改
/*------------------------------------------------------ */
