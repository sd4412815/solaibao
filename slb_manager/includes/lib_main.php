...
function create_shop_settiongs($supplier_id)
{
    ...
    if($num>0){
        ...
        $insql = "INSERT INTO ". $GLOBALS['ecs']->table('supplier_shop_config') ." (`id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order`, `supplier_id`) VALUES
				...
				(106, 1, 'shop_province', 'manual', '', '', '0', 2, ".$supplier_id."),
				(107, 1, 'shop_city', 'manual', '', '', '0', 52, ".$supplier_id."),
				(108, 1, 'shop_address', 'text', '', '', '', 1, ".$supplier_id."),
				(116, 1, 'shop_closed', 'select', '0,1', '', '0', 1, ".$supplier_id."),
				(117, 1, 'close_comment', 'hidden', '', '', '', 1, ".$supplier_id."),
				...
				(203, 2, 'template', 'hidden', '', '', 'dianpu', 1, ".$supplier_id."),
				...
				(802, 8, 'sms_order_placed', 'select', '1,0', '', '0', 1, ".$supplier_id."),
				(803, 8, 'sms_order_payed', 'hidden', '1,0', '', '0', 1, ".$supplier_id."),
				(804, 8, 'sms_order_shipped', 'hidden', '1,0', '', '0', 1, ".$supplier_id.");";
