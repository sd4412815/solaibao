...
$modules['02_cat_and_goods']['08_comment_manage']       = 'comment_manage.php?act=list';
...
$modules['02_cat_and_goods']['07_goods_storeroom']         = 'goods_storeroom.php?act=list';                   //代码增加
//$modules['02_cat_and_goods']['pricecut']             =   'pricecut.php?act=list&status=-1';               //商品降价通知


//$modules['03_promotion']['02_snatch_list']          = 'snatch.php?act=list';                              //奇宝夺兵
...
$modules['03_promotion']['20_wholesale']            = 'wholesale.php?act=list';
...
//$modules['05_banner']['ad_position']                = 'ad_position.php?act=list';                         //广告位置
...
//$modules['10_priv_admin']['agency_list']            = 'agency.php?act=list';                              //办事处管理
...
//$modules['11_system']['sitemap']                    = 'sitemap.php';                                      //站点地图
...
//$modules['12_template']['05_edit_languages']        = 'edit_languages.php?act=list';                      //语言编辑项
//$modules['12_template']['06_template_backup']       = 'template.php?act=backup_setting';                  //模板设置备份
...
//$modules['11_system']['website']  = 'website.php?act=list';                                               //合作登录管理

//$modules['03_promotion']['16_takegoods_list']       = 'takegoods.php?act=list';                           //提货券管理
//$modules['03_promotion']['16_takegoods_order']       = 'takegoods.php?act=order_list';                    //提货券退货列表
