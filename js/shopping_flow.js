...
function checkOrderForm(frm)
{
  ...
  // if ( ! shippingSelected)
  // {
  //     layer.msg(flow_no_shipping, function(){});
  ...
  // if ( ! paymentSelected)
  // {
  //   layer.msg(flow_no_payment, function(){});
...
function checkConsignee(frm)
{
  ...
  else if (Utils.isIDcard(frm.elements['id_card'].value))
  {
    err = true;
    msg.push(id_card_not_number);
  }
  else{

  }
  // if (Utils.isIDcard(frm.elements['id_card'].value))
  // {
  //   err = true;
  //   msg.push(id_card_not_number);
  // }
